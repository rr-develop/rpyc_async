#!/usr/bin/env python
"""
classic rpyc-async server (threaded, forking or std) running a SlaveService
usage:
    rpyc-async-classic                         # default settings
    rpyc-async-classic -m forking -p 12345     # custom settings

    # ssl-authenticated server (keyfile and certfile are required)
    rpyc-async-classic --ssl-keyfile keyfile.pem --ssl-certfile certfile.pem --ssl-cafile cafile.pem
"""
import sys
import os
import rpyc_async as rpyc
from plumbum import cli
from rpyc_async.utils.server import ThreadedServer, ForkingServer, OneShotServer
from rpyc_async.utils.classic import DEFAULT_SERVER_PORT, DEFAULT_SERVER_SSL_PORT
from rpyc_async.utils.registry import REGISTRY_PORT
from rpyc_async.utils.registry import UDPRegistryClient, TCPRegistryClient
from rpyc_async.utils.authenticators import SSLAuthenticator
from rpyc_async.lib import setup_logger
from rpyc_async.core import SlaveService
