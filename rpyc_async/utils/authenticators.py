...
:data:`configuration dict <rpyc_async.core.protocol.DEFAULT_CONFIG>` under the key "credentials".
...
Authenticators are used by :class:`~rpyc_async.utils.server.Server` to
...
"""
import sys
from rpyc_async.lib import safe_import
ssl = safe_import("ssl")
...
class SSLAuthenticator(object):
    ...
    :func:`rpyc_async.utils.factory.ssl_connect`. Classic clients can use directly
    :func:`rpyc_async.utils.classic.ssl_connect` which sets the correct
    service parameters.
    """
