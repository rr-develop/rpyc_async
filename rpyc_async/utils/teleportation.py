...
from rpyc_async.lib.compat import is_py_gte38, is_py_gte310, is_py_gte311
from types import CodeType, FunctionType
from rpyc_async.core import brine, netref
...
def import_function(functup, globals=None, def_=True):
    ...
    if isinstance(globals, netref.BaseNetref):
        from rpyc_async.utils.classic import obtain
