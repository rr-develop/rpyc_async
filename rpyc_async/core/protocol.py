...
from rpyc_async.lib.compat import pickle, next, maxint, select_error, acquire_lock  # noqa: F401
from rpyc_async.lib.colls import WeakValueDict, RefCountingColl
from rpyc_async.core import consts, brine, vinegar, netref
...
#            ('...BoundAgentService', ...). Possible memory leak on
#            remote side.
#
...
class Connection(object):
    ...
    def _extract_frames(self, chunk):
        ...
        from rpyc_async.core.channel import Channel  # noqa: PLC0415
