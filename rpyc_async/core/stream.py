...
import socket
import errno
from rpyc_async.lib import safe_import, Timeout, socket_backoff_connect
from rpyc_async.lib.compat import poll, select_error, BYTES_LITERAL, get_exc_errno, maxint  # noqa: F401
...
class SocketStream(Stream):
    ...
    # socket and spinning on a recycled fd — see a related internal incident
    # analysis (not included here) and docs/DESIGN_NO_POLLING_ASYNCIO_READ.md.
